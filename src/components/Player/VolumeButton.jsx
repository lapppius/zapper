...
export default function VolumeButton() {
	...
	let [initialVolume, setInitialVolume] = useState(0.49);
	let [initialMuted, setInitialMuted] = useState(false);
	...
	}, [volumeValue, mutedValue, gainNode, initialVolume]);
	...
	useEffect(() => {
		if (localStorage.getItem("volume")) {
			setInitialVolume(JSON.parse(localStorage.getItem("volume")).volume);
			setInitialMuted(JSON.parse(localStorage.getItem("volume")).muted);
		}
	}, []);
